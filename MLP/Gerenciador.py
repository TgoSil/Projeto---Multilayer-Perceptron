...
class Gerenciador:
    ...
    def MLP(self):
        ...
        for linha in self.entradas:
            ...
            saidasCamadas.append(self.camadas[0].camadaFeedFoward(linha)) # Feedforward na primeira camada
            ...
            print("Pesos e Bías:")
            self.camadas[0].camadaUpdate(deltasCamadas[0], linha, self.taxaAprendizado)
